...
module.exports = {
  ...
  watch : function ( input_dir, output_dir, use_requirejs ){
    ...
    watchr.watch({
      ...
      next : function ( err,watcher ){
        ...
        utils.build( utils.layout( use_requirejs ), input_dir, output_dir, use_requirejs );
      }
    });
  },

  build : function ( input_dir, output_dir, use_requirejs ){
    utils.input_dir = input_dir;
